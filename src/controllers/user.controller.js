...
const updateUserAvatar = asyncHandler( async (req, res) => {
    ...
    // TODO -> delete old Avatar -> make a utlity
...
const  getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
      ...
      {
        $lookup: {
          from: "subscriptions",  // Subscription -> stores in database as subscriptions
          localField: "_id",
      ...
      },
      {
        $lookup: {
          ...
          pipeline: [
            ...
            {
              // this is for frontend ease. A array will be returned.
              // thorugh this we will give first element directly
              $addFields: {
                owner: {
                  $first: "$owner"
                }
